      ...
      >
        <div className="container mx-auto px-3 sm:px-4 md:px-8">
          <div className={`flex items-center justify-between rounded-2xl px-4 sm:px-6 py-2.5 sm:py-3 transition-all duration-300 ${scrolled ? 'glass' : 'bg-transparent text-slate-800'}`}>
            ...
            {/* Logo */}
            <Link to="/home" className="flex items-center gap-2 cursor-pointer text-brand-600 hover:opacity-80 transition-opacity">
          ...
          <div className="fixed inset-0 z-[300] md:hidden">
            ...
            >
              ...
              <div className="flex items-center justify-between p-5 border-b border-slate-100">
                <Link to="/home" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-2 text-brand-600 hover:opacity-80 transition-opacity">
